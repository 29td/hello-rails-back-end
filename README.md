...
```sh
  cd my-folder
  git clone git@github.com:29td/hello-rails-back-end.git
```
...
- GitHub: [@TuyishimireEric](https://github.com/29td)
- LinkedIn: [@TuyishimireEric](https://www.linkedin.com/in/nonhlanhla-mndebele/)
- E-mail: <a href="mailto:nonhlanhlamndebele9@gmail.com">nonhlanhlamndebele9@gmail.com</a>
...
Feel free to check the [issues page](https://github.com/29td/hello-rails-back-end/issues).
